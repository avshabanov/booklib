package com.truward.book.server.service;

import com.truward.book.model.BookModel;
import com.truward.book.server.util.PersonRoleMapper;
...
public final class BookService {
  ...
  public interface Contract {
    @Nonnull
    BookModel.BookPageIds savePage(@Nonnull BookModel.BookPageData request);

    @Nonnull
    BookModel.BookPageIds delete(@Nonnull BookModel.BookPageIds request);

    @Nonnull
    BookModel.BookPageData getPage(@Nonnull BookModel.BookPageIdsRequest request);

    @Nonnull
    BookModel.BookList queryBooks(@Nonnull BookModel.BookPageQuery query);
    ...
    @Nonnull
    BookModel.NamedValueList queryPersons(@Nonnull BookModel.PersonListQuery query);

    @Nonnull
    BookModel.PersonNameHints getPersonHints(@Nullable String prefix);

    @Nonnull
    BookModel.NamedValueList querySeries(@Nonnull BookModel.SeriesQuery query);
  }
  ...
  public static final class Impl implements Contract {
    ...
    @Override
    @Nonnull
    public BookModel.BookPageIds savePage(@Nonnull BookModel.BookPageData request) {
    ...
    @Override
    @Nonnull
    public BookModel.BookPageIds delete(@Nonnull BookModel.BookPageIds request) {
      // Genres
    ...
    @Nonnull
    public BookModel.BookPageData getPage(@Nonnull BookModel.BookPageIdsRequest request) {
    ...
    @Transactional(readOnly = true)
    @Nonnull
    public BookModel.BookList queryBooks(@Nonnull BookModel.BookPageQuery query) {
    ...
    @Transactional(readOnly = true)
    @Nonnull
    public BookModel.NamedValueList queryPersons(@Nonnull BookModel.PersonListQuery query) {
      checkLimitBounds(query.getLimit());
    ...
    @Override
    @Nonnull
    public BookModel.PersonNameHints getPersonHints(@Nullable String prefix) {
    ...
    @Override
    @Nonnull
    public BookModel.NamedValueList querySeries(@Nonnull BookModel.SeriesQuery query) {
      checkLimitBounds(query.getLimit());
      final BookModel.NamedValueList.Builder builder = BookModel.NamedValueList.newBuilder();
      if (query.getLimit() == 0) {
        if (query.hasOffsetToken()) {
