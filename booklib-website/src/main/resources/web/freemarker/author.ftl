...
<div>
  <nav>
    <ul class="pager">
      <li><a href="/g/author/${pageModel.namedValue.id}">&lArr; First Page</a></li>
      <#if pageModel.startBookId??>
        <li><a href="/g/author/${pageModel.namedValue.id}?startBookId=${pageModel.startBookId}">Next Page &rarr;</a></li>
      </#if>
    </ul>
  </nav>
</div>
